...
const BASEGAME_ADDRESS = "0x635867d8d44775927c2831b24dd98c66c6ba0757"; // Deploy sonrası güncelle
const PASS_ADDRESS = "0x37EF8c801E0968F2f01005d27d923996429aa264"; // Deploy sonrası güncelle
const BASEGAME_ABI = [[
	{
		"inputs": [
			{
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract BaseGamePass",
				"name": "",
				"type": "address"
			}
		],
...
]]; // Remix’ten BaseGame ABI’sini kopyala
const PASS_ABI = [[
	{
		"inputs": [
			{
...
]]; // Remix’ten BaseGamePass ABI’sini kopyala
